/**
 * vue-i18n 初始化 + 语言持久化 + RTL 方向切换
 *
 * 支持三种语言：简体中文(zh-CN)、英文(en-US)、阿拉伯语(ar，RTL)。
 * 语言选择持久化到 localStorage('travel_locale')；切换时同步 <html lang/dir>。
 */
...
export const STORAGE_LOCALE = 'travel_locale'
export const SUPPORTED_LOCALES = ['zh-CN', 'en-US', 'ar']
export const DEFAULT_LOCALE = 'en-US'

/** locale → Intl 数字/货币格式化所用 locale（阿拉伯语统一拉丁数字，见 currency.js）。 */
